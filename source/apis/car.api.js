...
export class CarApi
{
        ...
        //获取页面文字内容
        find(json, callback, showLoading = true) {
          ...
          console.log(header);
          wx.request({
            url: ApiConfig.GetApiUrl() + 'car/find',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
        ...
        //获取页面文字内容
        sale(json, callback, showLoading = true) {
          ...
          console.log(header);
          wx.request({
            url: ApiConfig.GetApiUrl() + 'car/sale',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
        ...
        //获取页面文字内容
        memberfavorited(json, callback, showLoading = true) {
          ...
          console.log(header);
          wx.request({
            url: ApiConfig.GetApiUrl() + 'car/memberfavorited',
            data: json,
            method: 'POST',
            dataType: 'json',
            header: header,
